...
function AuroraBG() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden select-none" style={{ zIndex: -900 }}>
...
function MouseTrail(){
  ...
  useEffect(()=>{
    ...
    const onMove=(e:PointerEvent)=>{ 
      setPts(p=>[...p.slice(-20), {id:id++, x:e.clientX, y:e.clientY, t:Date.now()}]) 
    }
    // Lägger till både document och window för att säkerställa att det fungerar överallt
  ...
  return (
    <div className="pointer-events-none fixed inset-0" style={{ zIndex: -999 }}>
      <AnimatePresence>
        {pts.map(p=> (
          <motion.span 
            key={p.id} 
    ...
    return (
      <>
        ...
        <div className="min-h-screen w-full text-zinc-100 bg-[#0B0C10] flex items-center justify-center">
          <div className="text-center">
            <div className="text-2xl font-semibold mb-2">Laddar NASDAQ data...</div>
            <div className="text-zinc-400">Letar efter CSV data</div>
          </div>
        </div>
      </>
    )
  ...
  return (
    <>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-blue-900/20 rounded-lg p-4 border border-blue-600/30">
                  <h3 className="text-blue-300 font-semibold mb-2">Klassificering av marknadslägen</h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Modellen använder en binär klassificering där etiketten "1" tilldelas när indexet 
                    lyckas nå en uppgång på 10% inom en 70-dagarsperiod, utan att samtidigt falla 
                    mer än en tredjedel av målet i motsatt riktning. Alla andra fall får etiketten "0".
                  </p>
                </div>
                
                <div className="bg-green-900/20 rounded-lg p-4 border border-green-600/30">
                  <h3 className="text-green-300 font-semibold mb-2">Maskininlärningsmodell</h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Som huvudalgoritm implementeras en <code className="bg-gray-800 px-2 py-1 rounded text-xs">BalancedBaggingClassifier</code> 
                    från scikit-learn, med parallell beräkning på samtliga tillgängliga processorkärnor för optimal prestanda.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-purple-900/20 rounded-lg p-4 border border-purple-600/30">
                  <h3 className="text-purple-300 font-semibold mb-2">Arkitektur för det neurala nätverket</h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Implementationen följer en standardpipeline: först normaliseras alla features med MinMaxScaler, 
                    sedan tränas ett flerlagersnätverk med ett dolt lager som innehåller fyra gånger så många 
                    neuroner som antalet input-features. ReLU-aktivering och L2-regularisering används med 
                    alpha=0.001, med sigmoid som slutaktivering för att generera sannolikheter för positiv klass.
                  </p>
                </div>
                
                <div className="bg-cyan-900/20 rounded-lg p-4 border border-cyan-600/30">
                  <h3 className="text-cyan-300 font-semibold mb-2">Forskningssyfte och praktisk tillämpning</h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Målet med denna studie är att utveckla ett system som kan identifiera gynnsamma 
                    tillämplighetsfönster för 70-dagars investeringshorisonter. Studien strävar efter att 
                    erbjuda investerare intelligenta alternativ till traditionell dollar-cost-averaging, 
                    särskilt genom att identifiera marknadsperioder då det kan vara fördelaktigt att 
                    tillfälligt avstå från investeringar.
                  </p>
                </div>
              </div>
            </div>
          ...
          <InfoCard title="Modellen — dynamiska trendindikatorer">
            <div className="space-y-6">
              <div className="bg-purple-900/20 rounded-lg p-6 border border-purple-600/30">
                <p className="text-gray-300 leading-relaxed">
                  Modellen bygger på forskningsresultat från <strong className="text-purple-300">Bareket & Pârv (2024)</strong>. 
                  Systemet implementerar adaptiva tekniska indikatorer (EMA, TEMA, MomEma, MomTema, RCTema, RTF och SES→FWD SMA) 
                  optimerade för medellångsiktiga marknadsrörelser över cirka 70 handelsdagar. 
                  <strong className="text-purple-300"> Syftet är att identifiera optimala inträdespunkter för investeringar.</strong>
                </p>
              </div>
              
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-green-900/20 rounded-lg p-6 border border-green-600/30">
                  <h3 className="text-green-300 font-semibold mb-3">Dollar-Cost-Averaging (DCA)</h3>
                  <div className="space-y-3">
                    <div>
                      <h4 className="text-green-200 font-medium text-sm mb-2">Definition</h4>
                      <p className="text-gray-300 text-sm leading-relaxed">
                        Dollar-cost-averaging (DCA) innebär att bygga upp investeringar gradvis över tid 
                        med lika stora belopp vid regelbundna intervaller.
                      </p>
                    </div>
                    <div>
                      <h4 className="text-green-200 font-medium text-sm mb-2">Praktisk tillämpning</h4>
                      <p className="text-gray-300 text-sm leading-relaxed">
                        DCA förblir mycket populärt bland investerare och rekommenderas ofta av inflytelserika 
                        författare. Många fonder uppmuntrar uttryckligen investerare att göra regelbundna bidrag 
                        som en del av en DCA-strategi genom månatliga sparplaner.
                      </p>
                    </div>
                    <div className="text-xs text-gray-400 mt-3">
                      Källa: Bayes Business School, City University of London
                    </div>
                  </div>
                </div>
                
                <div className="bg-purple-900/20 rounded-lg p-6 border border-purple-600/30">
                  <h3 className="text-purple-300 font-semibold mb-3">Adaptiv modell</h3>
                  <div className="space-y-3">
                    <div>
                      <h4 className="text-purple-200 font-medium text-sm mb-2">Metodologi</h4>
                      <p className="text-gray-300 text-sm leading-relaxed">
                        Denna modell är utformad för att generera överavkastning under trendperioder genom 
                        tekniska indikatorer som integreras för att producera handelssignaler som 
                        identifierar gynnsamma köpfönster.
                      </p>
                    </div>
                    <div>
                      <h4 className="text-purple-200 font-medium text-sm mb-2">Tidshorisont</h4>
                      <p className="text-gray-300 text-sm leading-relaxed">
                        Analysen fokuserar på medellångsiktiga marknadsrörelser över cirka 70 handelsdagar 
                        för att optimera identifieringen av strategiska inträdespunkter.
                      </p>
                    </div>
                    <div>
                      <h4 className="text-purple-200 font-medium text-sm mb-2">Teoretisk grund</h4>
                      <p className="text-gray-300 text-sm leading-relaxed">
                        Under andra marknadsförhållanden kan traditionell DCA-strategi visa sig mer fördelaktig, 
                        vilket överensstämmer med hypotesen om effektiva marknader (EMH) och Random Walk-teorin.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section id="prenumeration" data-key="prenumeration" className="relative mx-auto max-w-6xl px-4 py-16 pb-32">
        <motion.div initial={{opacity:0, y:20}} whileInView={{opacity:1, y:0}} viewport={{ once:true, margin:'-60px' }} transition={{type:'spring', stiffness:220, damping:22}}>
          <InfoCard title="Prenumeration — steg för steg (kommer snart)">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              {[
                { 
                  step: "1", 
                  title: "Registrera", 
                  desc: "Ange din e-post för månadsrapporter", 
                ...
                { 
                  step: "2", 
                  title: "Konfigurera", 
                  desc: "Välj dina investeringspreferenser", 
                ...
                { 
                  step: "3", 
                  title: "Få signaler", 
                  desc: "Månatliga köprekommendationer", 
                ...
                <motion.div 
                  ...
                  whileHover={{y:-4, scale:1.02}}
                  className={`${item.bg} rounded-lg p-6 border ${item.border} transition-all duration-300`}
                >
                  <div className={`w-14 h-14 bg-gradient-to-br ${item.color} rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-lg shadow-lg`}>
                    {item.step}
                  </div>
                  <h3 className={`font-semibold ${item.textColor} mb-3 text-lg`}>{item.title}</h3>
            ...
            <div className="text-center">
              <motion.button
                ...
                className="bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 hover:from-blue-700 hover:via-purple-700 hover:to-green-700 text-white font-semibold text-lg px-10 py-4 rounded-lg shadow-xl border border-white/20 transition-all duration-300 hover:shadow-2xl"
              >
                Jag vill ha en månads‑påminnelse
              </motion.button>
              <p className="text-gray-400 text-sm mt-4">
                Kostnadsfritt • Inga förpliktelser • Avsluta när som helst
              </p>
            </div>
